      ...
      <ul className="menu bg-base-100 text-base-content">
        ...
        <div className="overflow-auto h-96">
          <h1>
            ...
            sit in dolorem pariatur. Autem veniam quod iure exercitationem
            itaque omnis ut aliquid facere repellat beatae maiores incidunt,
            corporis quisquam ab voluptates consequuntur labore? Illo velit quis
            soluta, accusamus in distinctio sequi amet pariatur recusandae natus
            sapiente ut omnis reiciendis sunt provident doloribus possimus ullam
            numquam voluptates? Consequuntur magnam optio saepe, at quidem totam
            esse ab placeat reiciendis, laborum consectetur nostrum illo
            veritatis debitis minus magni facere voluptatem! Repudiandae id
            voluptatum necessitatibus nostrum! Nisi similique sed, non placeat
            unde delectus magni libero tempore sit est. Voluptate dolores
            tempore ipsum ad excepturi!
          </h1>
